...
export default function OperationsLayout({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-fuchsia-50 to-pink-50">
      <header className="bg-gradient-to-r from-fuchsia-500 to-fuchsia-600 text-white shadow-lg">
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold">قسم العمليات</h1>
                <p className="text-sm text-fuchsia-100">قريباً ...</p>
              </div>
            </div>
            <Link href="/admin" className="text-fuchsia-100 hover:text-white transition-colors flex items-center gap-2">

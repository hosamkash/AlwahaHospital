...
// تعريف مجموعات القائمة - إظهار قسم إدارة الموقع فقط
const menuGroups = [
  {
    id: "website",
    title: "إدارة الموقع",
...
const routeMapping: { [key: string]: string } = {
  "website-0": "/pages/00-website/about-hospital",
  "website-1": "/pages/00-website/medical-services",
  "website-2": "/pages/00-website/vision-mission",
  "website-3": "/pages/00-website/contact-us",
  "website-4": "/pages/00-website/medical-team",
  "website-5": "/pages/00-website/contracting-parties",
}
...
export default function WebsiteLayout({
  ...
  const [moduleColor, setModuleColor] = useState<string>("#3b82f6") // default blue for website
  ...
  useEffect(() => {
    try {
      ...
      if (savedColors) {
        ...
        if (parsed && typeof parsed['website'] === 'string') {
          setModuleColor(parsed['website'])
        }
      }
    } catch (e) {
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold">إدارة الموقع</h1>
                <p className="text-sm opacity-90">إدارة محتوى الموقع الإلكتروني</p>
              </div>
            </div>

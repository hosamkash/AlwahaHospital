...
const routeMapping: { [key: string]: string } = {
  "invoices-0": "/pages/07-Invoices/فواتير المشتريات",
  "invoices-1": "/pages/07-Invoices/فواتير مرتجعات المشتريات",
  "invoices-2": "/pages/07-Invoices/فواتير المبيعات",
  "invoices-3": "/pages/07-Invoices/فواتير مرتجعات المبيعات",
}
...
export default function InvoicesLayout({
  ...
  const [expandedGroups, setExpandedGroups] = useState<string[]>(["invoices"])
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-sky-50">
      <header className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white shadow-lg">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-cyan-100">إدارة فواتير المشتريات والمبيعات</p>
              </div>
            </div>
            <Link href="/admin" className="text-cyan-100 hover:text-white transition-colors flex items-center gap-2">
                                  ...
                                  return route ? (
                                    <Link
                                      ...
                                      className={`block w-full text-right px-8 py-2 text-sm hover:bg-gray-100 transition-colors ${
                                        pathname === route ? "bg-cyan-100 text-cyan-700" : "text-gray-700"
                                      }`}
                                    >
                                      {item}
                                    </Link>

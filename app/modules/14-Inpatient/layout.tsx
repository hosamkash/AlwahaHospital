...
export default function InpatientLayout({
  ...
  const [expandedGroups, setExpandedGroups] = useState<string[]>(["inpatient"])
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold">قسم الداخلي (الإقامات)</h1>
                <p className="text-sm text-sky-100">قريباً ...</p>
              </div>
            </div>
            <Link href="/admin" className="text-sky-100 hover:text-white transition-colors flex items-center gap-2">

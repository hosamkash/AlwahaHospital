...
export default function ITLayout({
  ...
  const [expandedGroups, setExpandedGroups] = useState<string[]>(["it"])
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-zinc-50">
      <header className="bg-gradient-to-r from-gray-600 to-gray-700 text-white shadow-lg">
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold">إدارة تكنولوجيا المعلومات</h1>
                <p className="text-sm text-gray-200">قريباً ...</p>
              </div>
            </div>
            <Link href="/admin" className="text-gray-200 hover:text-white transition-colors flex items-center gap-2">

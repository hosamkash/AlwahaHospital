...
export default function GeneralServicesLayout({
  children,
}: {
  ...
  const [expandedGroups, setExpandedGroups] = useState<string[]>(["general-services"])
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold">إدارة الخدمات العامة</h1>
                <p className="text-sm text-slate-100">قريباً ...</p>
              </div>
            </div>
            <Link href="/admin" className="text-slate-100 hover:text-white transition-colors flex items-center gap-2">

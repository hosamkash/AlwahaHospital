...
const routeMapping: { [key: string]: string } = {
  "pharmacy-0": "/pages/12-Pharmacy/طلب دواء",
  "pharmacy-1": "/pages/12-Pharmacy/صرف دواء للعيادات / المرضى",
  "pharmacy-2": "/pages/12-Pharmacy/إدارة وصفات الأطباء",
  "pharmacy-3": "/pages/12-Pharmacy/إدارة مخزون الأدوية",
  "pharmacy-4": "/pages/12-Pharmacy/تنبيهات انتهاء الصلاحية",
  "pharmacy-5": "/pages/12-Pharmacy/جرد الصيدلية",
  "pharmacy-6": "/pages/12-Pharmacy/تقارير الصيدلية",
}
...
export default function PharmacyLayout({
  ...
  const [expandedGroups, setExpandedGroups] = useState<string[]>(["pharmacy"])
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-lime-50 to-green-50">
      <header className="bg-gradient-to-r from-lime-500 to-lime-600 text-white shadow-lg">
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold">قسم الصيدلية</h1>
                <p className="text-sm text-lime-100">إدارة الأدوية والوصفات والمخزون</p>
              </div>
            </div>
            <Link href="/admin" className="text-lime-100 hover:text-white transition-colors flex items-center gap-2">
                                  ...
                                  return route ? (
                                    <Link
                                      ...
                                      className={`block w-full text-right px-8 py-2 text-sm hover:bg-gray-100 transition-colors ${
                                        pathname === route ? "bg-lime-100 text-lime-700" : "text-gray-700"
                                      }`}
                                    >
                                      {item}
                                    </Link>

...
export default function OutpatientLayout({
  children,
}: {
  ...
  const [expandedGroups, setExpandedGroups] = useState<string[]>(["outpatient"])
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold">قسم العيادات الخارجية</h1>
                <p className="text-sm text-blue-100">قريباً ...</p>
              </div>
            </div>
            <Link href="/admin" className="text-blue-100 hover:text-white transition-colors flex items-center gap-2">

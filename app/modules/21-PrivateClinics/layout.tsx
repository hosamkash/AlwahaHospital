...
export default function PrivateClinicsLayout({
  children,
}: {
  ...
  const [expandedGroups, setExpandedGroups] = useState<string[]>(["private-clinics"])
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold">قسم العيادات الخاصة</h1>
                <p className="text-sm text-purple-100">قريباً ...</p>
              </div>
            </div>
            <Link href="/admin" className="text-purple-100 hover:text-white transition-colors flex items-center gap-2">

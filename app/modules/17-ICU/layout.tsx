...
export default function ICULayout({
  ...
  const [expandedGroups, setExpandedGroups] = useState<string[]>(["icu"])
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold">قسم العناية المركزة</h1>
                <p className="text-sm text-red-100">قريباً ...</p>
              </div>
            </div>
            <Link href="/admin" className="text-red-100 hover:text-white transition-colors flex items-center gap-2">

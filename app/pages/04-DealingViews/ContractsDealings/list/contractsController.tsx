...
// بيانات قوائم الأسعار المتاحة مع التفاصيل الكاملة
export const availablePriceLists = [
  {
    id: 1,
    name: "قائمة الأسعار الأساسية",
    code: "BASIC",
    description: "قائمة الأسعار الأساسية للمرضى العاديين",
    active: true,
    discountType: "percentage",
    globalDiscountPercentage: 10,
    services: [
      { id: 1, code: "S001", name: "كشف طبي عام", originalPrice: 200, discountValue: 20, discountPercentage: 10, listPrice: 200, finalPrice: 180, type: "service" },
      { id: 2, code: "S002", name: "كشف طبي متخصص", originalPrice: 300, discountValue: 30, discountPercentage: 10, listPrice: 300, finalPrice: 270, type: "service" }
    ],
    items: [
      { id: 1, code: "I001", name: "أدوية مسكنة", originalPrice: 50, discountValue: 5, discountPercentage: 10, listPrice: 50, finalPrice: 45, type: "item" }
    ],
    analysis: [
      { id: 1, code: "A001", name: "تحليل دم شامل", originalPrice: 150, discountValue: 15, discountPercentage: 10, listPrice: 150, finalPrice: 135, type: "analysis" }
    ],
    radiology: [
      { id: 1, code: "R001", name: "أشعة سينية للصدر", originalPrice: 100, discountValue: 10, discountPercentage: 10, listPrice: 100, finalPrice: 90, type: "radiology" }
    ],
    operations: [
      { id: 1, code: "O001", name: "عملية بسيطة", originalPrice: 1000, discountValue: 100, discountPercentage: 10, listPrice: 1000, finalPrice: 900, type: "operation" }
    ]
  },
  {
    id: 2,
    name: "قائمة الأسعار المميزة",
    code: "PREMIUM",
    description: "قائمة الأسعار المميزة مع خصومات أكبر",
    active: true,
    discountType: "percentage",
    globalDiscountPercentage: 20,
    services: [
      { id: 1, code: "S001", name: "كشف طبي عام", originalPrice: 200, discountValue: 40, discountPercentage: 20, listPrice: 200, finalPrice: 160, type: "service" }
    ],
    items: [],
    analysis: [],
    radiology: [],
  ...
  {
    id: 3,
    name: "قائمة الأسعار للشركات",
    code: "CORPORATE",
    description: "قائمة أسعار خاصة بالشركات والمؤسسات",
    active: true,
    discountType: "fixed",
    globalDiscountPercentage: 15,
    services: [
      { id: 1, code: "S001", name: "كشف طبي عام", originalPrice: 200, discountValue: 30, discountPercentage: 15, listPrice: 200, finalPrice: 170, type: "service" }
    ],
    items: [],
    analysis: [],
    radiology: [],
  ...
  {
    id: 4,
    name: "قائمة الأسعار للتعاقدات",
    code: "CONTRACT",
    description: "قائمة أسعار للجهات المتعاقدة",
    active: true,
    discountType: "percentage",
    globalDiscountPercentage: 25,
    services: [],
    items: [],
    analysis: [],
    radiology: [],
  ...
  {
    id: 5,
    name: "قائمة الأسعار للطلاب",
    code: "STUDENT",
    description: "قائمة أسعار مخفضة للطلاب",
    active: true,
    discountType: "percentage",
    globalDiscountPercentage: 30,
    services: [],
    items: [],
    analysis: [],
    radiology: [],
  ...
  {
    id: 6,
    name: "قائمة الأسعار للموظفين",
    code: "EMPLOYEE",
    description: "قائمة أسعار للموظفين والعاملين",
    active: true,
    discountType: "percentage",
    globalDiscountPercentage: 40,
    services: [],
    items: [],
    analysis: [],
    radiology: [],
  ...
  {
    id: 7,
    name: "قائمة الأسعار للكبار",
    code: "SENIOR",
    description: "قائمة أسعار خاصة لكبار السن",
    active: true,
    discountType: "percentage",
    globalDiscountPercentage: 35,
    services: [],
    items: [],
    analysis: [],
    radiology: [],
  ...
  {
    id: 8,
    name: "قائمة الأسعار للأطفال",
    code: "CHILD",
    description: "قائمة أسعار خاصة بالأطفال",
    active: true,
    discountType: "percentage",
    globalDiscountPercentage: 20,
    services: [],

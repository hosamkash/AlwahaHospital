...
export default function SupplayChecksListPage() {
  ...
  const filteredChecks = filterSupplayChecksByDate(
    searchSupplayChecks(searchTerm),
    dateFilter,
    fromDate,
    toDate,
    selectedMonth
  ...
  const handleNewCheckClick = () => {
    router.push('/modules/06-Financial/10-SupplayChecks/form')
  }

  const handleEditCheckClick = (id: number) => {
    router.push(`/modules/06-Financial/10-SupplayChecks/form?id=${id}`)
  }
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-gray-800">عرض شيكات القبض - الشيكات الواردة</h2>
              ...
              <tbody>
                {filteredChecks.map((check, index) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-gray-600">{supplayChecksUtils.formatDate(check.creationDate)}</td>
                    <td className="py-3 px-4 text-gray-600">{supplayChecksUtils.formatDate(check.dueDate)}</td>
                    ...
                    <td className="py-3 px-4 font-medium text-gray-800">{supplayChecksUtils.formatAmount(check.amount)}</td>
                    <td className="py-3 px-4 text-gray-600">{check.statement}</td>
                    <td className={`py-3 px-4 font-medium ${supplayChecksUtils.getCollectedColor(check.isCollected)}`}>
                      {check.isCollected ? "تم التحصيل" : "لم يتم التحصيل"}
                    </td>
                    <td className={`py-3 px-4 font-medium ${supplayChecksUtils.getRejectedColor(check.isRejected)}`}>

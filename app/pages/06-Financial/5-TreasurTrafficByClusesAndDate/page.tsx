  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-center">
        <h2 className="text-2xl font-bold text-gray-800">حركة خزائن النقدية - تجميع بالتاريخ + البند</h2>
      </div>
              ...
              <tbody>
                {filteredData.map((traffic, index) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-gray-600">{treasurTrafficByClusesAndDateUtils.formatDate(traffic.date)}</td>

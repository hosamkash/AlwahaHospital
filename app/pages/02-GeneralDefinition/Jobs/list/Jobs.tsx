    ...
    <div className="space-y-6">
        <>
          ...
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-gray-800">عرض الوظائف</h2>
            <div className="flex items-center gap-2">
              <Button className="bg-primary" onClick={() => router.push(`${basePrefix}/02-GeneralDefinition/Jobs/form`)}>
                  ...
                  <tbody>
                    {filteredJobs.map((job) => (
                      <tr key={job.id} className="border-b border-gray-100 hover:bg-gray-50">
                        <td className="py-3 px-4">
                          <div className="flex items-center gap-2">
                            <Button 
                              size="sm" 
                              variant="outline"
                              onClick={() => router.push(`${basePrefix}/02-GeneralDefinition/Jobs/form?id=${job.id}`)}
                            >
                        ...
                        <td className="py-3 px-4 text-gray-600">{job.code}</td>
                        <td className="py-3 px-4 font-medium text-gray-800">{job.name}</td>
                        <td className="py-3 px-4">
                        ...
                        <td className="py-3 px-4 text-gray-600 max-w-xs truncate">{job.description}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>

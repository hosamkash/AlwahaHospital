...
import DepartmentsItem from "../form/departmentsItem"
import { 
...
export default function Departments() {
  ...
  const filteredDepartments = searchDepartments(searchTerm)
      ...
      {showDepartmentDetails && selectedDepartment ? (
        ...
        <>
          ...
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-gray-800">عرض الإدارات والأقسام</h2>
          ...
          <div className="relative">
            ...
            <Input
              ...
              placeholder="ابحث عن إدارة أو قسم...."
              value={searchTerm}
                  ...
                  <tbody>
                    {filteredDepartments.map((department) => (
                      <tr key={department.id} className="border-b border-gray-100 hover:bg-gray-50">
                        <td className="py-3 px-4">
                          <div className="flex items-center gap-2">
                            <Button 
                              size="sm" 
                              variant="outline"
                              onClick={() => router.push(`${computeFormPath()}?id=${department.id}`)}
                            >
                        ...
                        <td className="py-3 px-4 text-gray-600 max-w-xs truncate">{department.description}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
